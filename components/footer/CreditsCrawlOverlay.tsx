...
const creditsData: CreditItem[] = [
  {
    section: "Organizers",
    items: ["Z. Erden Dereli", "Mirza Eker", "İsmail and Eyüp", "Mr Ceyhun", "Mirzahan Akın"],
  },
  {
    section: "Communities",
    ...
    >
      ...
      <style>{`
        @keyframes crawl {
          from {
            opacity: 0;
            transform: translateZ(0) rotateX(30deg) translateY(100px);
          }
          10% {
            opacity: 1;
          }
          ...
          to {
            opacity: 0;
            transform: translateZ(0) rotateX(30deg) translateY(-1500px);
          }
        }
